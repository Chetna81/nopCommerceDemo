...
public class Utils extends BasePage {
    ...
    //SendText element
    public static void sendTextToElement(By by, String text1) {
        driver.findElement(by).sendKeys((CharSequence) text1);
    }
    ...
    public void userShouldBeNavigateToProductListPage() {
    }

    public void userClickOnCustomerCurrency() {
    }
